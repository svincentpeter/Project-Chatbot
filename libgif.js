...
(function (root, factory) {
    ...
    var SuperGif = function ( opts ) {
        ...
        var setSizes = function(w, h) {
            ...
            eyebrowCanvas.getContext('2d', { willReadFrequently: true }).setTransform(1, 0, 0, 1, 0, 0);

            blinkCanvas.width = w;
            blinkCanvas.height = h;
            blinkCanvas.style.zIndex = 2;
            blinkCanvas.getContext('2d', { willReadFrequently: true }).setTransform(1, 0, 0, 1, 0, 0);
