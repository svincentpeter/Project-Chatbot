...
function getVoices() {
	if(voiceSelecter){
        voiceSelecter.innerHTML = "<option value='Google Bahasa Indonesia' selected='selected'>Google Bahasa Indonesia</option>";
